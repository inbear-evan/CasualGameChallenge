...
namespace Com.TheFallenGames.OSA.Editor.OSAWizard
{
	public class CreateOSAWindow : BaseOSAWindow<CreateOSAWindow.Parameters>
	{
		...
		public static bool Validate(bool forOpeningWindow, out string reasonIfNotValid)
		{
			...
			// GetCurrentPrefabStage was introduced in 2018.3: https://docs.unity3d.com/ScriptReference/Experimental.SceneManagement.PrefabStageUtility.html
			bool insidePrefabEditingScene = UnityEditor.Experimental.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null;
#else
			bool insidePrefabEditingScene = false;
#endif
			if (!insidePrefabEditingScene && !GameObject.FindObjectOfType<EventSystem>())
			{
