...
namespace Yellotail.InGame
{
    public class CameraController : MonoBehaviour
    {
        ...
        public void RotateTowardDirection(Vector3 _direction, float _lookSpeed)
        {
            ...
            float _xAngleDifference = CMF.VectorMath.GetAngle(new Vector3(0f, _currentLookVector.y, 1f), new Vector3(0f, _direction.y, 1f), Vector3.right);

            //Calculate y angle difference;
            _currentLookVector.y = 0f;
            _direction.y = 0f;
            float _yAngleDifference = CMF.VectorMath.GetAngle(_currentLookVector, _direction, Vector3.up);
