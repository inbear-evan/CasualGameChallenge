...
namespace Yellotail.InGame
{
    public class InGameCameraController : CameraController
    {
        ...
        public CMF.Controller controller;
        ...
        public void RotateTowardsVelocity(Vector3 _velocity, float _speed)
        {
            ...
            _velocity = CMF.VectorMath.RemoveDotVector(_velocity, GetUpDirection());

            //Calculate angle difference of current direction and new direction;
            float _angle = CMF.VectorMath.GetAngle(GetFacingDirection(), _velocity, GetUpDirection());
