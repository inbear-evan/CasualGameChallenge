...
namespace Yellotail
{
...
#endif
    {
        ...
        public float transitionUntouchedDuration = 0.1f;
        public float transitionTouchedDuration = 0.1f;
        ...
        // SCRIPT REFERENCE //
        private static readonly Dictionary<string, UltimateJoystick> UltimateJoysticks = new Dictionary<string, UltimateJoystick>();
        ...
        private void Awake()
        {
            ...
            if (Application.isPlaying && !string.IsNullOrEmpty(joystickName))
            {
